...
if ($_SERVER['REQUEST_METHOD']=='POST')
{
 ...
 $search="select * from Employee where Eemail='$email'";
 ...
 if (mysqli_num_rows($execute) > 0) {
  ...
  $query="update Employee set Epassword='$Pass' where Eemail='$email'";
...
<div class="container">
  ...
  <h2 class="login-header"><a href="UserLogin.php"> <img src="Image/back.jpg"  width="50px" height="50px"  alt="Bid" /> </a>  &nbsp&nbsp&nbsp Change Password</h2>
